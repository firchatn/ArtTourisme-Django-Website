...
urlpatterns = [
    ...
    url(r'^produit/poterie/$', views.cat_view_poterie, name='cat_view_poterie'),
    url(r'^produit/mosaique/$', views.cat_view_mosaique, name='cat_view_mosaique'),
    url(r'^produit/bijoux/$', views.cat_view_bijoux, name='cat_view_bijoux'),
    url(r'^produit/cuivre/$', views.cat_view_cuivre, name='cat_view_cuivre'),
